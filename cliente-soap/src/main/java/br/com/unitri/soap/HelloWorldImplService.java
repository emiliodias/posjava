 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://soap.unitri.com.br/", wsdlLocation = "http://localhost:8080/helloworldsoapws/services/HelloWorldSOAPWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://soap.unitri.com.br/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/helloworldsoapws/services/HelloWorldSOAPWS?wsdl");
     ...
     * 
     * @return
     *     returns HelloWorldSOAP
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldSOAP getHelloWorldImplPort() {
        return super.getPort(new QName("http://soap.unitri.com.br/", "HelloWorldImplPort"), HelloWorldSOAP.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldSOAP getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.unitri.com.br/", "HelloWorldImplPort"), HelloWorldSOAP.class, features);
    }
